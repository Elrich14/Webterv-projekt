        ...
        <div class="signup">
            <form action="signup.php" method="POST">
                <fieldset>
                    ...
                    <input type="text" id="username" name="username" value="<?php if (isset($_POST['username'])) echo $_POST['username']; ?>" placeholder="felhasználó123"> <br>

                    <label for="signup_email">E-mail cím:</label> <br>
                    <input type="email" id="signup_email" name="signup_email" placeholder="valami@gmail.com"> <br>

                    <label for="password">Jelszó:</label> <br>
                    <input type="password" id="password" name="password" minlength="6" placeholder="Min. 6 karakter"> <br>

                    <label for="password-check">Jelszó újra:</label> <br>
                    <input type="password" id="password_check" name="password_check" minlength="6"> <br>
...
if (isset($_POST["signup_submit"])){
    ...
    /*if ($date_of_birth < 15)
        $errors[] = "<p class='signup'>Csak 15 éves kortól lehet regisztrálni!</p> "; /*?????????????????????????????????????????????????????????*/

    if (count($errors) === 0) {
        echo "<p class='reg'>Sikeres regsztráció!</p> ";
        $data = [
            "username" => $username,
